...
import { getMemberCare } from "../../care/actions";
...
export default async function MemberDetailPage({
  ...
  const [memberOrNull, statusLog, leaves, groupInfo, newFamilyEntry, ministryTeams, care] = await Promise.all([
    getMember(memberId),
